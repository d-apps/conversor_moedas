...
// Constante, nunca altera
const request = "https://api.hgbrasil.com/finance?format=json&key=4d4b03dc";
...
Future<Map> getData() async{
  ...
  http.Response response = await http.get(request); // Retorna um dado futuro, não chega na hora
